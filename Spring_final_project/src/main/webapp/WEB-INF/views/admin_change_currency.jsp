...
<head>
    ...
    <title>Change Currency|ADMIN</title>
        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <div class="col-md-6 col-8 align-self-center">
                    <h3 class="text-themecolor m-b-0 m-t-0">Update Exchange Values</h3><br>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">${currency_exchange.currencies.name}</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-block">
                            <form class="form-horizontal form-material" action="add_currency_exchange" method="post">
                                <div class="form-group">
                                    <label for="example-email" class="col-md-12">Purchase Value</label>
                                    <div class="col-md-12">
                                        <input type="text" name="currency_purchase_value" value="${currency_exchange.purchase_value}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="currency_sale_value" value="${currency_exchange.sale_value}"
                                ...
                                <input type="hidden" name="currency_id" value="${currency_exchange.currencies.id}">
                                <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                            </form>
                        </div>
                    </div>
