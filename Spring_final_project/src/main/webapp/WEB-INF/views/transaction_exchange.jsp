        ...
        <div class="col-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-sample" id="transaction" action="add_transaction_exchange" method="post">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Exchange</label>
                                    <div class="col-sm-9">
                                        <select class="form-control" name="exchange" required>
                                            <option value="tenge alu" selected>Sale</option>
                                            <option value="tenge beru">Purchase</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
