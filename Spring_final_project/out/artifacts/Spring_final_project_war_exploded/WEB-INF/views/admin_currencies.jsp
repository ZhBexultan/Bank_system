        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <div class="col-md-6 col-8 align-self-center">
                    <h3 class="text-themecolor m-b-0 m-t-0">Currencies</h3>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-block">
                            <h4 class="card-title">Today's Currency Exchange Values</h4>
                            <div class="table-responsive m-t-40">
                                <table class="table stylish-table">
                                    <thead>
                                    <tr>
                                        <th disabled>Currency</th>
                                    ...
                                    <c:if test="${currency_exchange!=null}">
                                        <c:forEach items="${currency_exchange}" var="currency">
                                    <tbody>
                                    <tr>
                                        <td>${currency.currencies.name}</td>
                                        <td>${currency.purchase_value}</td>
                                        <td>${currency.sale_value}</td>
                                        <td>${currency.assigned_time}</td>
                                        <td><a href="admin_change_currency?id=${currency.id}">Edit</a></td>
                                    </tr>
                                    </tbody>
                                        </c:forEach>
                                    </c:if>
